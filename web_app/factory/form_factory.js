...
function form_factory() {
    ...
    */
    this.item_factory = function (options) {
        ...
        if (options.node_input) {
            form_item.node_input.addEventListener("change", function (e) {
                // assign value
                form_item.q = e.target.value
                console.log(form_item.q);
            })
        }
    ...
    */
    this.build_form_item = function (options) {
        ...
        const form_item = {
            ...
            q_splittable: options.q_splittable || false, // depending on its value the item content will be spitted or not on loading it
            ...
            // category. thesaurus terms and not terms
            ...
            node_input: options.node_input || null,
            node_values: options.node_values || null,
    ...
    */
    ...
    /**
    * SET_FORM_ITEM
    * Set a input node of the form with the value and config search of the psqo item object
    */
    ...
    this.build_filter = function (options = {}) {
        ...
        for (let [id, form_item] of Object.entries(form_items)) {
            ...
            if ((form_item.q.length !== 0 && form_item.q !== '*') || (form_item.sql_filter)) {
                ...
                // Like 'legend <img data="{'lat':'452.6'}">' to 'legend <img data="{''lat'':''452.6''}">'
    ...
    */
    this.full_text_search_operators_info = function () {
        ...
        const pairs = [
            ...
            {
                op: "()",
                info: tstring.group_words || "Group words into sub-expressions (allowing them to be included, excluded, ranked, and so forth as a group)."
            },
            {
                op: "~",
        ...
        $(form_item.node_input).autocomplete({
            ...
            select: function (event, ui) {
                ...
                if (form_item.node_values) {
                    ...
                    self.set_input_value(form_item, ui.item.value)
                }
