...
function map_factory() {
    ...
    // map_container (created inside map_container)
    ...
    */
    this.init = function (options) {
        ...
        const map_container = options.map_container || self.map_container
        ...
        const popup_options = options.popup_options || {
            ...
            // maxHeight					Number	null	If set, creates a scroll-able container of the given height inside a popup if its content exceeds it.
            // maxHeight : 420,
    ...
    */
    this.render_base_map = function () {
        ...
        return new Promise(function (resolve) {
            ...
            const container = self.map_container || common.create_dom_element({
                element_type: "div",
                class_name: "map",
    ...
    */
    ...
    /**
    * BUILD_POPUP_CONTENT
    * Send callback option to overwrite current function
    */
